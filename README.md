...
Generate polished, on-brand grocery flyers (PNG) from simple JSON or text data. The system uses Node.js, Handlebars for templating, and Puppeteer for export. An optional local LLM (Ollama) helps with analysis and parsing, but JSON input works without AI.
